...
class Mces_Quiz implements ActionListener{

    String[] questions = 	{
            "Which is the first microcontroller?",
            "Which one of the following is an asynchronous communication channel?",
            "The 8-bit microcontrollers are used to execute _________",
            "Which of these is an example of 16 bit microcontroller?"
    };
    String[][] options = 	{
            {"TMS1000","8051","Arm","Intel 4004"},
            {"MUDs","SPI","MOO","VOIP"},
            {"Arithmetic operations only","Logical operations only","Both A and B","None of the above"},
            {"8031 MC","8051 MC","8096 MC","None of the above"}
    };
    char[] answers = 		{
            'A',
            'B',
