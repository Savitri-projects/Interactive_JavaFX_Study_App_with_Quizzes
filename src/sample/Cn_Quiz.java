...
class Cn_Quiz implements ActionListener{
    ...
    String[][] options = 	{
            {"Double Duplex","Simplex","Half duplex","Full duplex"},
            {"Encryption of Data","To detect errors","To transmit faster","To identify the user"},
            {"HTTp","E-mail system","World wide web","Mailing list"},
            {"E-mail address","ICQ","URL","Protocol"}
    };
    char[] answers = 		{
            'A',
            'B',
