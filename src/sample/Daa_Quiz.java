...
class Daa_Quiz implements ActionListener{

    String[] questions = 	{
            "Which case of Master’s theorem is applicable in the recurrence relation T(n)=0.5*T(n/2)+1/n?",
            "Division Pattern of Problems in Divide and Conquer approach uses",
    ...
    String[][] options = 	{
            {"Not applicable","Case 1","Case 2","Case 3"},
            {"Iterative","Recursive","Parallel","Random"},
            {"O(1)","O(n)","O(n^2)","O(log n)"},
            {"Stack","List","Queue","None of the above"}
    };
    char[] answers = 		{
            'A',
            'B',
